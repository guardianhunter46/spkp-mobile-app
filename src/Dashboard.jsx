      ...
      <div className="bg-gradient-to-br from-blue-600 to-blue-800 p-8 rounded-b-[3.5rem] shadow-xl">
        <div className="flex justify-between items-center mt-6">
          <div className="flex items-center space-x-4">
            {/* Foto Profil / Avatar */}
            <div className="w-16 h-16 bg-white/20 backdrop-blur-lg rounded-2xl flex items-center justify-center border border-white/30 shadow-inner">
            ...
            <div>
              ...
              <p className="text-blue-100 text-xs opacity-80 font-medium">ID: {userData?.username || 'KRY-001'}</p>
            </div>
          </div>
      ...
      <div className="px-6 mt-10">
        ...
        <div className="grid grid-cols-2 gap-5">
          {[
            ...
            <div key={idx} className="bg-white p-6 rounded-[2rem] shadow-sm border border-slate-100 flex flex-col items-center justify-center text-center space-y-3 active:scale-95 transition-all cursor-pointer hover:shadow-md">
              <div className={`w-14 h-14 ${item.color} rounded-2xl flex items-center justify-center text-3xl shadow-sm`}>
                {item.icon}
              </div>
      ...
      <div className="px-6 mt-10">
        <div className="bg-white p-6 rounded-[2rem] shadow-sm border border-slate-100 relative overflow-hidden">
            <div className="absolute top-0 right-0 p-4">
                <span className="px-3 py-1 bg-green-100 text-green-700 text-[10px] font-black rounded-full uppercase tracking-widest">Hadir</span>
            </div>
